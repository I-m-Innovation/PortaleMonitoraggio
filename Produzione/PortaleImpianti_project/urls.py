"""
URL configuration for PortaleImpianti_project project.
...
urlpatterns = [
    ...
    path("corrispettivi/", include('PortaleCorrispettivi.urls')),
    path("overview/", views.overview_main, name='overview-main'),
    path("overview/alessi/", views.overview_alessi, name='overview-alessi'),
    path("overview/cavarzan/", views.overview_cavarzan, name='overview-cavarzan'),
